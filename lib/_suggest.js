...
function onSelect(message, flags) {
    var self = this, opts = this.opts, nameKey = opts.nk, valueKey = opts.vk, name = nameKey ? message[nameKey] : message["1" /* name */], value = valueKey ? message[valueKey] : (message["3" /* id */] || message["2" /* value */]);
    if (!flags) {
